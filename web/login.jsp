...
<section class="bg-[#f0f1f1]">
    <div class="grid items-center py-8 mt-20 mx-56 md:h-screen lg:py-0">
        <div>
                ...
                <div class="w-full p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" action="Login" method="post">
                        ...
                        <p class="text-sm font-light text-gray-700">
                            Don’t have an account yet? <a href="#" class="font-medium text-primary-600 hover:underline text-[#007eca]">Sign up</a>
                        </p>
                    </form>
