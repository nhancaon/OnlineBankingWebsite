...
<%
    String initAmount = (String) session.getAttribute("iniAmount");
%>
<div class="bg-[#f0f1f1] mt-[5.2rem] pb-16">
    ...
    <div class="grid grid-cols-6 gap-8">
            ...
            <div class="w-full grid grid-cols-1">
                <c:if test="${ savingAccount.accountStatus == 'Active' }">
                    <form action="with-draw" method="post">
                        <div class="grid grid-cols-3 border-b-2 py-2 mb-3">
                            ...
                            <div class="col-span-2 text-end text-gray-500 text-sm">Saving Id: ${savingAccount.savingAccountId}</div>
                            ...
                            <div class="text-end text-xl text-green-400">${initAmount}VND</div>
                ...
                <c:if test="${ savingAccount.accountStatus != 'Active' }">
                    <div class="grid grid-cols-3 border-b-2 py-2 mb-3">
                        ...
                        <div class="col-span-2">Savings Deposit : </div>
                        <div class="text-end text-xl text-red-400">${initAmount}VND</div>
                        <div class="col-span-2">Expected Amount Received : </div>
        ...
        <div class="flex justify-between items-center">
            ...
            <span class="uppercase text-sm">${savingAccount.minBalance}</span>
        </div>
