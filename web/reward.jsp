...
<div class="bg-[#f0f1f1] mt-[5.2rem] pb-16">
    <div class="py-16 mx-2 md:mx-56">
        ...
        <div class="">
            ...
            <div class="grid mt-16 rounded-xl bg-white">
                ...
                <div class="md:p-10 p-6 bg-gray-200 grid grid-cols-2 md:grid-cols-4 gap-5">
                    <form action="Rewards" method="get">
                        ...
                        <button
                            type="submit"
                            class="w-full grid justify-center items-center bg-white h-32 rounded-xl focus:ring transform transition hover:scale-105 duration-300 ease-in-out"
                            >
            ...
            <div class="grid mt-16 rounded-xl bg-white">
                <div class="md:px-10 px-6 py-6">Gift Suggestions</div>
