<%@page import="business.Transaction"%> <%@page import="java.util.List"%>
<%@page import="DAO.PaymentAccountDAO"%> <%@page
import="business.PaymentAccount"%> <%@ include file="/includes/header.jsp"%> <%@
include file="/includes/checkLogin.jsp" %> <% PaymentAccount paymentAccount =
(PaymentAccount) request.getAttribute("paymentAccount"); List<Transaction>
        ...
        <div class="grid grid-cols-6 gap-8">
          <div class="col-span-4 my-16 py-8 px-20 rounded-xl bg-white">
            <div class="w-full grid grid-cols-1">
              <% if (transactionList != null) { for (Transaction transaction :
              transactionList) { if
              (transaction.getSender().getAccountNumber().equals(paymentAccount.getAccountNumber()))
              {%>
              <div class="grid grid-cols-3 border-b-2 py-2 mb-3">
                ...
                <div class="col-span-2">
                  ...
                  transaction.getTransactionRemark()%>
                </div>
